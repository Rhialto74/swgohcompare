...
@Component({
  selector: 'app-comparison-mods-mobile',
  templateUrl: './comparison-mods-mobile.component.html',
  styleUrls: ['./comparison-mods-mobile.component.css']
})
export class ComparisonModsMobileComponent implements OnInit {
